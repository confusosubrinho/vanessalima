...
function WhatsAppFloatInner(_props: Record<string, never>, ref: React.ForwardedRef<HTMLAnchorElement>) {
  ...
  return (
    <a
      ...
      className={`fixed ${bottomClass} right-4 sm:right-6 z-50 bg-[#25D366] hover:bg-[#20bd5a] text-white p-4 rounded-full shadow-2xl transition-all hover:scale-110 group`}

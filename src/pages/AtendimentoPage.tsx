        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-4 gap-6 mb-12">
            <div className="bg-muted/30 rounded-xl p-6 text-center space-y-3">
              ...
              <a href="tel:42991120205" className="text-sm text-muted-foreground hover:text-primary block">42 99112-0205</a>
            </div>
            <div className="bg-muted/30 rounded-xl p-6 text-center space-y-3">
              <div className="w-12 h-12 bg-primary/10 rounded-full flex items-center justify-center mx-auto">
              ...
              <a href="mailto:contato@vanessalimashoes.com.br" className="text-sm text-muted-foreground hover:text-primary block">contato@vanessalimashoes.com.br</a>
            </div>
            <div className="bg-muted/30 rounded-xl p-6 text-center space-y-3">
              <div className="w-12 h-12 bg-primary/10 rounded-full flex items-center justify-center mx-auto">
              ...
              <p className="text-sm text-muted-foreground">Rua Professor Cleto - até 669/670<br/>União da Vitória - PR<br/>CEP: 84600140</p>
            </div>
            <div className="bg-muted/30 rounded-xl p-6 text-center space-y-3">
              <div className="w-12 h-12 bg-primary/10 rounded-full flex items-center justify-center mx-auto">
          ...
          <div className="flex justify-center mb-12">
            <a
              href="https://wa.me/5542991120205?text=Olá, preciso de ajuda!"
              target="_blank"
